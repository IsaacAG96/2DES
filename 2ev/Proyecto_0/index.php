...
if ($_SERVER['REQUEST_METHOD'] == "GET") {
    ...
    } else if (isset($_GET['nav-modificar']) && isset($_GET['id'])) { // Proceso las ordenes de navegación en modificar
...
if (ob_get_length() == 0) {
    ...
    $orden = isset($_GET['ordenar']) ? $_GET['ordenar'] : $_SESSION['orden'];
